var ControllerName = ApplicationName + '/TALAB_M2M_SAF/';
var period_id;
var mission;
var mission_gehat;
var mission_det;
...
$(document).ready(function () {
    ...
    $('#REP').on('click', function (event) {
        // window.open('../REPORTS/PER_M2M/REP_M2M.aspx?MISSION_ID='+mission, '_blank');
        off_rep();
    });
                       ...
                       { text: 'نوع المأمورية', dataField: 'TYP_NAME', cellsalign: 'center', align: 'center', width: '20%' },//
                                                     {
                                                         ...
                                                         text: 'طباعه', columntype: 'button', cellsalign: 'center', filterable: false, width: '5%', align: 'center', cellsrenderer: function (row, datafield, value) {
                                                             return "<img  style='margin-left: 5px;margin-top:-10px; cursor:pointer;' height='15' width='25' src='images/edit.png' onclick='off_rep();'/>";
                                                         }
                                                     },
...
function build_mission_member_grid() {
    ...
    theme = "darkblue";
    headerText = " درجات الأخري المأموريات";
    gridAddUrl = 'TALAB_M2M_SAF/Create_Off';
...
function bnd_mission_member_grid(firm_code, fin_year, PERIOD_ID, date, person_id, MISSION_ID) {
    ...
    var source = {
        ...
        url: 'TALAB_M2M_SAF/GET_grid_m2m_mem',
...
function bnd_mission_grid(firm_code, fin_year, PERIOD_ID, date, person_id) {
    ...
    var source = {
        ...
        url: 'TALAB_M2M_SAF/GET_grid_m2m',
...
function bnd_ROLE_grid(firm_code, fin_year, PERIOD_ID, person_id) {
    ...
    var source = {
        ...
        url: 'TALAB_M2M_SAF/GET_grid_ROLE',
...
function bnd_gehat_grid() {
    ...
    var source = {
        ...
        url: 'TALAB_M2M_SAF/GET_grid_gehat',
        data: {}
...
function build_static() {
    //  $("#DT_DATE").jqxDateTimeInput({animationType: 'fade', width: '80%', height: 38, rtl: true, dropDownHorizontalAlignment: 'right', theme: "darkblue" , formatString: 'dd/MM/yyyy hh:mm:ss' });
...
function seet_fin_year() {
    ...
    $.ajax({
        url: "TALAB_M2M_SAF/GET_fin_year",
        // data: { ID: pid, FIRM: frm },
...
function open_confirm(row, gridId) {
    ...
    if (gridId.id == "dt_firm_missions") {
        ...
        openConfirmDialog_m2m(url, data_row1, gridId.id, details.OFF_ABS_GROUP_ID);
    }
...
function off_rep() {
    ...
    var xxx = "../WORKFLOW_APP/REPORTS/Rep_gwab_mam/TalabM2morya.aspx?MISSION=" + mission;
    document.getElementById("show_rep").src = "../WORKFLOW_APP/REPORTS/Rep_gwab_mam/TalabM2morya.aspx?MISSION=" + mission + "&FIRM_CODE=" + firm_cod;
