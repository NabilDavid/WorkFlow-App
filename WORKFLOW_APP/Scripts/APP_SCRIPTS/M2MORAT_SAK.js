...
function build_static() {
    ...
    $('#page_name').text(' المــأموريــات - درجات أخري');
...
function build_mission_grid() {
    ...
    $("#dt_firm_missions").jqxGrid({
        ...
        columns: [
                       ...
                       { text: 'الجهة', dataField: 'FIRM_NAME', cellsalign: 'center', align: 'center', width: '35%' },
...
function dt_firm_missions_Refresh(firm_code, fin_year, PERIOD_ID, date, person_id) {
    ...
    var source = {
        ...
        url: 'TALAB_M2M_SAK/GET_grid_m2m',
...
function build_mission_member_grid() {
    ...
    theme = "darkblue";
    headerText = "  تفاصيل المأموريات";
    gridAddUrl = 'TALAB_M2M_SAK/Create_OFF';
...
function bnd_mission_grid1(firm_code, fin_year, PERIOD_ID, date, person_id) {
    debugger
    $('#dt_firm_missions').jqxGrid('clearselection');
    var source = {
        datatype: "json",
...
function bnd_mission_member_grid(firm_code, fin_year, PERIOD_ID, date, person_id, MISSION_ID) {
    ...
    var source = {
        ...
        url: 'TALAB_M2M_SAK/GET_grid_m2m_mem',
...
function bnd_ROLE_grid(firm_code, fin_year, PERIOD_ID, person_id) {
    ...
    var source = {
        ...
        url: 'TALAB_M2M_SAK/GET_grid_ROLE',
