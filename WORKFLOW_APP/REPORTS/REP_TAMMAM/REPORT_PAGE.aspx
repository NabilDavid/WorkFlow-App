<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="REPORT_PAGE.aspx.cs" Inherits="WORKFLOW_APP.REPORTS.REP_TAMMAM.REPORT_PAGE" %>
            ...
            <ContentTemplate>
                <div>
                    ...
                    <rsweb:ReportViewer Visible="false" ID="ReportViewer1" runat="server" BorderColor="#333399" BorderStyle="Double" Font-Names="Verdana" Font-Size="8pt" Height="767px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1068px">
                        <LocalReport ReportEmbeddedResource="WORKFLOW_APP.REPORTS.REP_TAMMAM.PERORT_TAMMAM.rdlc">
                        </LocalReport>
                    </rsweb:ReportViewer>
