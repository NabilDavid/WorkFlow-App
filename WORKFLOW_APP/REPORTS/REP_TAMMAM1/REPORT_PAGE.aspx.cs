...
";
            ...
            string xx5 = @"
              ...
              GET_FEE(TO_CHAR(PERSON_DAILY_ENTRY_FEE.FEE_TIME,'HH24:mi'), to_char(person_daily_entry.entry_date,'HH24:mi')) as daily_period
...
";
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/REPORTS/REP_TAMMAM1/PERORT_TAMMAM1.rdlc");
