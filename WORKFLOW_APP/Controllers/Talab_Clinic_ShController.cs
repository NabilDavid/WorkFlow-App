...
{
    public class Talab_Clinic_ShController : Controller
    {
        ...
        public JsonResult bind_data_clinic(string fromdate, string FirmCode)
        {
...
//                           AND PD.OUT_UN_FORCE = 0";
        ...
        public int add_rec(string PERSON_CODE, string fin_year, string period_id, string firms, string RANK_CAT_ID, string person_rank_cat, int ABSENCE_TYPE_ID, string FullDateFrom, string FullDateTo)
        {
            ...
            // Validation where order is exiest 
//            var V_query = @"
//         SELECT PERSON_CODE,
//               FIN_YEAR,
//               TRAINING_PERIOD_ID,
...
//            var V_data = General.returnqueryresult(V_query);
//            int aaaaa = V_data.Tables[0].Rows.Count;
...
";
            ...
            //            var g = db.OFF_ABS_GROP_OFF.First(o => o.PERSON_DATA_ID == PERSON_CODE && o.ABS_CAT_ID == 10 && o.OFF_ABS_GROUP.FIRMS_CODE == firms).OFF_ABS_GROUP_ID;
            ...
            //         OFF_ABS_STEPS.OFF_ABS_GROUP_ID,
            //         OFF_ABS_STEPS.OFF_ABS_STEPS_NAME,
            //         OFF_ABS_STEPS.OFF_ROLE_ARCHIVE AS ROL,
            //         ORDER_ID,
            //        FIRMS_ABSENCES_PERSONS_DET.FIRMS_ABSENCES_PERSONS_DET_ID ,
            //         OFF_ABS_GROP_OFF.PERSON_DATA_ID,
            //  persn_name.RANK || ' / ' || persn_name.PERSON_NAME as PERSON_NAME,
            ...
            //           WHERE FIRMS_ABSENCES_PERSONS_DET.PERSON_DATE_OWEN = person_data.PERSON_CODE
            //                 AND PERSON_DATA.RANK_ID = RANKS.RANK_ID ) persn_name
            //   WHERE OFF_ABS_GROP_OFF.OFF_ABS_GROUP_ID = OFF_ABS_STEPS.OFF_ABS_GROUP_ID
            //         AND FIRMS_ABSENCES_PERSONS_DET.OFF_ABS_GROUP_ID(+) =
            //                OFF_ABS_GROP_OFF.OFF_ABS_GROUP_ID
            //         AND FIRMS_ABSENCES_PERSONS_DET.OFF_ABS_STEPS_ID(+) =
            //                OFF_ABS_STEPS.OFF_ABS_STEPS_ID
            //         AND FIRMS_ABSENCES_PERSONS_DET.PERSON_DATE_OWEN = persn_name.PERSON_CODE(+)and
            //OFF_ABS_STEPS.OFF_ABS_GROUP_ID=" + g + @"
            //and OFF_ABS_GROP_OFF.PERSON_DATA_ID=" + PERSON_CODE + @" 
            //and to_date(FIRMS_ABSENCES_PERSONS_DET.FROM_DATE) = to_date('" + FROM_DATE + @"' , 'dd/mm/yyyy')
            //order by ORDER_ID
            //";
