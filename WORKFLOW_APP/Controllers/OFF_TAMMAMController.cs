...
{
    public class OFF_TAMMAMController : Controller
    {
...
-- FIRMS_ABSENCES_PERSONS.FROM_DATE  >=     TO_DATE('" + date + @"','dd/mm/yyyy') AND  FIRMS_ABSENCES_PERSONS.ACT_DATE <= NVL(FIRMS_ABSENCES_PERSONS.ACT_DATE ,TO_DATE('" + date + @"','dd/mm/yyyy')) 
       (to_date('" + date + @"','dd/mm/yyyy') between  to_date(FIRMS_ABSENCES_PERSONS.FROM_DATE) and  to_date(FIRMS_ABSENCES_PERSONS.ACT_DATE))) 
