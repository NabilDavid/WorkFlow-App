...
{
    public class KHDMA_CHANGController : Controller
    {
        Boolean status = true;
        string title = "";
        string type = "success";
        ...
        public ActionResult add_exc(string FIRM, Int16 TYP, string PC1, string PC2, string F_DT, string T_DT)
        {
            ...
            d1.FIRM_CODE = FIRM;
            d1.FROM_DATE = fdt;
            d1.TO_DATE = d1.FROM_DATE.AddDays(1);
            d1.PERSON_DATE_OWEN = PC2;
            db.FIRMS_ABSENCES_PERSONS_DET.Add(d1);
            max += 1;
            // adding group steps for p2

            var pg = db.OFF_ABS_GROP_OFF.Any(o => o.PERSON_DATA_ID == PC2 && o.ABS_CAT_ID == 2) ?
                db.OFF_ABS_GROP_OFF.First(o => o.PERSON_DATA_ID == PC2 && o.ABS_CAT_ID == 2).OFF_ABS_GROUP_ID :
            ...
            foreach (var s in steps)
            {
                ...
                det.PERSON_DATE_OWEN = old_abs != null ? old_abs.PERSON_DATE_OWEN : null;
            ...
            if (DT2 != null)
            {
                ...
                abs2.TO_DATE = abs2.FROM_DATE.AddDays(1);
                ...
                d2.TO_DATE = d2.FROM_DATE.AddDays(1);
                ...
                var pg1 = db.OFF_ABS_GROP_OFF.Any(o => o.PERSON_DATA_ID == PC1 && o.ABS_CAT_ID == 2) ?
                    db.OFF_ABS_GROP_OFF.First(o => o.PERSON_DATA_ID == PC1 && o.ABS_CAT_ID == 2).OFF_ABS_GROUP_ID :
                    db.OFF_ABS_GROUP.First(o => o.UNIT_DEF_GROUP == 1 && o.ABSCENCE_CATEGORY_ID == 2).OFF_ABS_GROUP_ID;
                ...
                foreach (var s in steps1)
                {
                    ...
                    det.TO_DATE = ((DateTime)DT2).AddDays(1);
