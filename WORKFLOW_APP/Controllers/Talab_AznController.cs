...
{
    public class Talab_AznController : Controller
    {
        ...
        // get data of AznGrid
        public JsonResult bind_data_Azn(string fromdate, string FirmCode, string PersonId)
        {
